...
var playerPath: Dictionary[String, Array] = {"user1": users_story["user1"], "user2": []}
var usersQuestions: Dictionary[String, Array] = {"user1": users_story["user1"], "user2": []}
...
func resetPlayerPath() -> void:
	playerPath = {"user1": [users_story["user1"][0]], "user2": []}
	usersQuestions = {"user1": [users_story["user1"][0]], "user2": []}
